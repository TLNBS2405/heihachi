...
class MyTestCase(unittest.TestCase):
    ...
    def test_complete_parent_input(self):
        ...
        self.assertEqual(
            move7.on_ch,
            "[+31a (+21)](https://wavu.wiki/t/Bryan_combos#Staples 'Combo')",
        )
    ...
    def test_process_links(self):
        self.assertEqual(
            wavu_reader._process_links("[[Snake_Edge|Snake Edge]]"),
            "[Snake Edge](https://wavu.wiki/t/Snake_Edge 'Snake Edge')",
        )
        (
            self.assertEqual(
                wavu_reader._process_links("[[Azucena combos#Mini-combos|+27a]]"),
                "[+27a](https://wavu.wiki/t/Azucena_combos#Mini-combos 'Mini-combo')",
            ),
        )
